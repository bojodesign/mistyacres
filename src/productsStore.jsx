...
// Generate IDs based on category and order
const productsArray = Object.entries(productsByCategory).flatMap(
	([categoryName, products]) => {
		return products.map((product, index) => ({
			...product,
			id: `${categoryName[0].toLowerCase()}${index.toString().padStart(2, '0')}`,
