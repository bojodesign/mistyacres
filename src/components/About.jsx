			...
			<Container>
				...
				<Row>
					<Col lg={{ span: 8, offset: 2 }}>
						<p className="lead">We are a native plant nursery located in the central plateau, Taupo region, growing for the revegetation, large commercial, or landscaping projects.</p>
					</Col>
					<Col lg={{ span: 8, offset: 2 }}>
					...
					<Col lg={{ span: 8, offset: 2 }}>
						<p className="lead">We also have large grades of some species available, for instant gratification.</p>
					</Col>
					<Col lg={{ span: 8, offset: 2 }}>
						<p className="lead">The plant height when planted is important to get above weeds or grass growth and help to ward off rabbit and hare attack.</p>
					</Col>
				</Row>
			</Container>
		</section>
